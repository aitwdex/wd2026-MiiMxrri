...
export async function getYokohamaWeather(){
    const url = "https://api.open-meteo.com/v1/forecast?latitude=35.444&longitude=139.637&current_weather=true&hourly=precipitation_probability&daily=temperature_2m_max,temperature_2m_min";
  ...
  <div class="p-3 border rounded bg-white shadow-sm">
        <div class="border-bottom pb-2 mb-3">
          <div class="fs-2 fw-bold border-start border-primary border-4 ps-2">横浜の天気</div>
          </div>
