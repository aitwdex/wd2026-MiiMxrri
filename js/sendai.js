...
export async function getSendaiWeather(){
    const url = "https://api.open-meteo.com/v1/forecast?latitude=38.268&longitude=140.869&current_weather=true&hourly=precipitation_probability&daily=temperature_2m_max,temperature_2m_min";
  ...
  <div class="p-3 border rounded bg-white shadow-sm">
        <div class="border-bottom pb-2 mb-3">
          <div class="fs-2 fw-bold border-start border-primary border-4 ps-2">仙台の天気</div>
          </div>
